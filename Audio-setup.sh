...
# This script is originally created by  brendaningram and its just tampered and modified by me to suit my needs
set -e
...
#----------------------------------------------------
# Install distrho-ports(AKA. Some linux audio plugins)
#---------------------------------------------------
notify "Installing Distrho-ports(Linux audio plugins)"
...
# ---------------------------
# FINISHED!
# Now it will now reboot after that enjoy  and make music!
# ---------------------------
notify "Done - now rebooting."
sudo reboot
